...
* [Go 1.16のgo:embedとNext.jsの相性が悪い問題と戦う](https://future-architect.github.io/articles/20210409/)
に近い研究記事です。
...
詳しい作り方、説明は[go-swaggerでhello world](https://future-architect.github.io/articles/20200824/)をお読みください。
...
[上記記事](https://future-architect.github.io/articles/20200824/)と同じswagger.yamlを用意して、serverパッケージを生成します。
...
こちらも過去記事[Electronの使い方 Web開発の技術でデスクトップアプリを作ろう](https://future-architect.github.io/articles/20210107/)で詳しく説明しています。
...
詳しくは[Go 1.16からリリースされたgo:embedとは](https://future-architect.github.io/articles/20210208/)をお読みください。
