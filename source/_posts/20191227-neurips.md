...
少し前に[NeurIPSという学会に参加して来たことをご報告](https://future-architect.github.io/articles/20191210/)しましたが、今回はNeurIPSで気になった論文をいくつか紹介したいと思います。


# 言語・認知理解

まず、田中から言語理解や認知機能に関する研究を紹介します。
...
SuperGLUEは[こちら](super.gluebenchmark.com)のリンクから使用できます。
...
上野からは画像認識・生成に関する下記2つの研究を取り上げます。
