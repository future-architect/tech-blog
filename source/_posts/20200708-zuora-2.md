...
* [Zuora連載１：Zuora Central Platform概要](https://future-architect.github.io/articles/20200706/)
...
<img src="/images/20200708/photo_20200708_01.jpeg">
...
<img src="/images/20200708/1.png" style="border:solid 1px #000000">
...
1. **クレデンシャルを発行**: Zuora Central Platform 管理ページよりクレデンシャルを作成します。
   * 1.1. メニューより、「管理者」を選択
   <img src="/images/20200708/2.png" class="img-small-size" style="border:solid 1px #000000"><br>
   * 1.2. 「ユーザーの管理」を選択
   <img src="/images/20200708/3.png" style="border:solid 1px #000000">
   * 1.3. 「OAuth クライアント」から新規クライアントを作成し、 `client_id` と `client_secret` を保存します。
   <img src="/images/20200708/4.png">
2. OAuth API をリクエストして Bearer トークンを取得  
   ...
   * Type を 「OAuth 2.0」へ設定し、「Get New Access Token」を押下します。
   <img src="/images/20200708/Get_New_Access Token.png">
   ...
   * <img src="/images/20200708/request_token.png">
   * 2.3. アクセストークンが作成されます。
   <img src="/images/20200708/access_token.png">
3. Bearer トークンを Authorization ヘッダーに付与してリクエスト  
   ...
   * 3.1. 先ほど作成したトークンを指定します。
   <img src="/images/20200708/select_token.png">
   * 3.2. URL とサンプルの Body をセットし、リクエストを実行します。
   <img src="/images/20200708/sample_request.png">
   * 3.3. 以下のように返却されると成功です。
   <img src="/images/20200708/response_success.png">
...
* [本当に使ってよかった OpenAPI (Swagger) ツール | Future Tech Blog - フューチャーアーキテクト](https://future-architect.github.io/articles/20191008/)
