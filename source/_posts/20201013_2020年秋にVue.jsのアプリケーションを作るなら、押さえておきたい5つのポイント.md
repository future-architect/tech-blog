...
![](/images/20201013/image.png)

断念した最大の理由は、メジャーなライブラリのバージョンがalpha版である事です。

![](/images/20201013/image_2.png)

上記の状況からVue3はまだまだアーリーアダプトすぎる印象です、コントリビュートするチャンスとも考えられますが...Vuetyfyレベルの有名かつ大規模なライブラリのVue3本格対応などが良い分水嶺になるかなと考えております。
