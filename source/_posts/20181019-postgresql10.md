...
注目は3行目の `loops=3` のところでしょうか。どのパーティションにもwk_inputの3行に対し3回のアクセスがあることが確認できます。

図にすると次のようなイメージです。
<img src="/images/20181019/3.png">
...
<img src="/images/20181019/4.png">

実際は次図のようになっているということです。
<img src="/images/20181019/5.png">
