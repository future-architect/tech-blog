...
ちなみに、OpenCensus/OpenTelemetryでぐぐると僕の書いた[弊社の技術ブログの記事](https://future-architect.github.io/articles/20190604/)が上位に出てきます。Chromeのシークレットウインドウで検索をすると日本語では1位、英語でも10位以内でした。自慢です。
...
Dockerfileはこんな感じです。[仕事でPythonコンテナをデプロイする人向けのDockerfile (1): オールマイティ編](https://future-architect.github.io/articles/20200513/)で紹介したエッセンスがいろいろ入っています。今後はマルチステージビルド必須です。BuildKitといったビルド高速化のソリューションもマルチステージビルドをしなければほぼ意味がありません。Docker力を鍛えるにはまずマルチステージビルドです。
...
Dockerfileは以下のような感じです。こちらは[仕事でPythonコンテナをデプロイする人向けのDockerfile (2): distroless編](https://future-architect.github.io/articles/20200514/)で紹介したDistrolessを使っています。
