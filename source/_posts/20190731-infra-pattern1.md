...
2014年キャリア入社、TIG[^1]所属の二木です。読み方は「フタギ」ではなく「ニキ」と読みます。メンバーからは「N i K i」といった雰囲気で呼ばれています。入社後は、流通・小売業界の案件にて、インフラ全体を設計/構築/運用するチームに所属し、日々成長を実感しながら過ごしています。
...
* **『!!!!!! ソースコード以外は全てインフラ領域である !!!!!!』** 
    * ※詳細は[こちらの記事](https://future-architect.github.io/articles/20170109/)をどうぞ
...
**図1:インフラ知財のディレクトリ構成**
<img src="/images/20190731/photo_20190731_01.png">
...
<img src="/images/20190731/photo_20190731_02.png">
...
現在、同じ失敗繰り返さないために、 **利用者が設計背景・意図をしっかりと理解できる** よう、インフラ知財の整備を進めています。タイトルにあるようにデザインパターンのパターンとは、「状況」「問題」「解決」「名前」の4要素で構成されているかと思いますが、「解決」のための手段を提供するだけではなく、「状況」「問題」にもしっかりフォーカスを当てることが今まで弊社で行っていた過去の知財管理と異なる点です。
...
**図3:Winners‘ Circle**
<img src="/images/20190731/photo_20190731_03.png" style="border:solid 1px #000000">
※全く見せられなくてすいません...
...
**図4:インフラ知財整備活動の計画**
<img src="/images/20190731/photo_20190731_04.png">
