...
![](/images/20201112/LambdaからLambda.png)
...
![](/images/20201112/LambdaからLambda-VPCLambda.png)
...
APIでLambda関数を呼び出した場合、呼び出し元の環境変数が使えなくなるのでは？と思う方もいるかもしれませんが、実は環境変数もちゃんとセットされます。

呼び出し元のLambda関数のハンドラは以下のようにしておきます。
