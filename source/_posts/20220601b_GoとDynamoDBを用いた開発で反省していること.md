...
<img src="/images/20220601b/失敗談技術ブログ.drawio.png" alt="失敗談技術ブログ.drawio.png" width="1200" height="698" loading="lazy">
...
列挙すると事前に回避ないしは途中で方向転換できそうな内容が多く、アーキテクチャ的な意思決定であったマネジメントレベルの調整ができなかったんだなと感じました。
