title: "GoのWebアプリ開発で割り切ったパッケージ構成とテスト方針にした結果"
...
[澁川さん記事](https://future-architect.github.io/articles/20200528/)でいう、いわゆる "最小構成" を採用しました。これを試してみたという記事は見当たらなかったのでレア度が高い記事かもしれません。チーム規模は3-5人程度がコンスタントに開発していました。
