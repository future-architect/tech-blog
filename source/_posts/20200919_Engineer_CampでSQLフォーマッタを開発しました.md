...
フューチャーのインターンについては[こちらの記事](https://future-architect.github.io/articles/20200606/)をご覧ください！
...
もともとフューチャーではuroboroSQL formatterというSQLフォーマッタが開発されていました。（このフォーマッタについては[こちらの記事](https://future-architect.github.io/articles/20170228/)をご覧ください！）
...
ANTLRはパーサ（構文解析器）を生成するためのOSSです。パーサとは、コードの処理構造を解析し、結果をASTという表現で出力するプログラムです。（ANTLRやパーサに関する詳しい説明は[こちらの記事](https://future-architect.github.io/articles/20200903/)をご覧ください）
